...
public class AdverbVarDaoImpl extends AbstractDao implements AdverbVarDao {
	...
	public AdverbVar findById(Integer id) throws SystemException {
		...
		try {
			result = em.find(AdverbVar.class, id);
	...
	public List<AdverbVar> findAll() throws SystemException {
		List<AdverbVar> result;
		TypedQuery<AdverbVar> query = em.createQuery("FROM AdverbVar",
				AdverbVar.class);
