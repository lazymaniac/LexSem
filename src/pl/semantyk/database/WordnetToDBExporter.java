...
public class WordnetToDBExporter {
    ...
    private final CrudDao lexicalRelDao = getDaoFor(LexicalRelRaw.class);
    private final CrudDao relationTypeDao = getDaoFor(RelationType.class);
    private final CrudDao synsetRelDao = getDaoFor(SynsetRelationRaw.class);
    private final CrudDao synsetDao = getDaoFor(SynsetRaw.class);
    ...
    private void exportWnUnits() {
        ...
        LOG.info(noDup.size() + " units to persist.");
        try {
    ...
    private void exportSynset() {
        ...
        LOG.info(noDup.size() + " synsets to persist.");
        try {
    ...
    private void exportRelationTypes() {
        ...
        watch.start();
        LOG.info(dictionary.getRelationTypes().size() + " relation types persisted.\n");
    ...
    private void exportLexicalRelations() {
        ...
        LOG.info(noDup.size() + " lexical relations to persist.");
        try {
